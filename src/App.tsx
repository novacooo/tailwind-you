...
export const App = () => (
  <TailwindYouProvider sourceColor="#6750A4">
    <div className="bg-background-light dark:bg-background-dark flex h-screen w-full items-center justify-center gap-40">
